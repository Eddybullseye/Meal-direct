...
import { CAMPUSES, PRESET_LOCATIONS, DELIVERY_SLOTS, MENU_ITEMS } from '../mockData';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6" id="cart_workspace">
        ...
        <div className="space-y-6">
          <GlassPanel className="p-6 bg-emerald-strong text-white border-t-4 border-t-mango-warm">
            ...
            <div className="space-y-3.5 text-xs text-emerald-100 pt-2 pb-4 border-b border-white/12">
            ...
            <label className="flex items-start gap-2.5 bg-emerald-deep/30 rounded-xl p-3 border border-white/8 cursor-pointer select-none mb-6">
              <input
                type="checkbox"
                checked={acknowledgedQuote}
                onChange={(e) => setAcknowledgedQuote(e.target.checked)}
                className="w-4.5 h-4.5 rounded text-emerald-deep accent-mango-warm cursor-pointer mt-0.5"
                id="ack_quote_checkbox"
              />
              <span className="text-[10px] leading-relaxed text-emerald-100">

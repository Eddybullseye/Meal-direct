    ...
    <AppShell activeTab="home">
      ...
      {activeOrders.length > 0 && (
        <section className="mb-8" id="active_order_tracker">
          <div className="bg-mango-warm/15 border border-mango-warm/30 rounded-2xl p-5 shadow-sm">
      ...
      <section className="mb-8" id="delivery_estimator_widget">
        <GlassPanel className="p-6">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-72 bg-[#10231C]/5 border border-emerald-deep/8 p-5 rounded-2xl flex flex-col justify-between gap-4">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-2 mt-1">
                  ...
                  {trend === 'improving' && (
                    <span className="inline-flex items-center gap-0.5 bg-emerald-100 text-emerald-strong border border-emerald-200 text-[10px] font-bold px-1.5 py-0.5 rounded-md animate-bounce" title="Delivery parameters are currently improving">
                      <ArrowUp className="w-3 h-3 stroke-[3]" />
                      <span>Faster</span>
                    </span>
                  )}
                  {trend === 'worsening' && (
                    <span className="inline-flex items-center gap-0.5 bg-rose-100 text-danger border border-rose-200 text-[10px] font-bold px-1.5 py-0.5 rounded-md animate-pulse" title="Delivery parameters are currently worsening">
                ...
                <p className="text-[9.5px] text-muted-grey mt-1">Simulated delivery countdown window</p>
              </div>
      ...
      <section className="mb-8 bg-white rounded-2xl p-6 border border-emerald-deep/8" id="slot_selector_widget">
